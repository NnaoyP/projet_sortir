...
/**
 * @ORM\Entity(repositoryClass="App\Repository\ParticipantAreaRepository")
 */
class ParticipantArea
{
    /**
     * @ORM\Id()
     * @ORM\GeneratedValue()
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Trip", mappedBy="participantArea")
     */
    private $trips;
